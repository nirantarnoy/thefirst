...
<div class="panel panel-headline">
    <div class="panel-heading">
        <div class="btn-group">
            <?= Html::a(Yii::t('app', '<i class="fa fa-plus"></i> สร้างใบเคลมสินค้า'), ['create'], ['class' => 'btn btn-success']) ?>
        </div>
        <h4 class="pull-right"><?=$this->title?> <i class="fa fa-bolt"></i><small></small></h4>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="pull-right">
                    <form id="form-perpage" class="form-inline" action="<?=Url::to(['claim/index'],true)?>" method="post">
